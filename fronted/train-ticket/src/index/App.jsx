...
import {exchangeFromTo,showCitySelector,hideCitySelector,
    fetchCityData,setSelectedCity,showDateSelector,hideDateSelector,setDepartDate
,toggleHighSpeed,} from './action'
import { bindActionCreators } from 'redux'
import DateSeletor from '../common/DateSeletor'
import { h0 } from '../common/fp';

function App (props){
    const {from,to,dispatch,isCitySelectorVisible,cityData,isDateSelectorVisible,departDate,highSpeed,} = props;
